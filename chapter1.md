...
使得给定页面所需的所有对象都位于相邻位置。这解释了为什么您可以快速跳转到在Web浏览器
...
### 版本摘要
PDF完全向后兼容（您可以将PDF版本1.0文档加载到为PDF 1.7设计的程序中）
...
* 预览版是Mac OS X上用于PDF文档的预安装PDF查看器和浏览器插件。它功能强大，速度非常快，
